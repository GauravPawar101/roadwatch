...
if command -v wsl >/dev/null 2>&1; then
    wsl -d Ubuntu -- bash -lc 'source ~/.profile >/dev/null 2>&1; cd /mnt/c/Users/Gaurav/Desktop/roadWatch/fabric/network; ./scripts/start.sh'
else
    source ~/.profile >/dev/null 2>&1
    cd /mnt/c/Users/Gaurav/Desktop/roadWatch/fabric/network
    ./scripts/start.sh
fi
